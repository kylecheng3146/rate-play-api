...
//         public WireController(WireRepository wireRepository)
//         {
...
//         {
//             if (!_wireRepository.TryGetDataById(id, out var 線材櫃))
//             {
//                 return NotFound();
//             }
//             return Ok(線材櫃);
...
//         [ProducesResponseType(200)]
//         [ProducesResponseType(404)]
//         public ActionResult<線材櫃> GetByWire(string stove_code)
//         {
//             // return wire;
//             if (!_wireRepository.TryGetByWire(stove_code, out var wire))
//             {
//                 return NotFound();
//             }
//             return Ok(wire);
...
//             await _wireRepository.AddDataAsync(線材櫃);
