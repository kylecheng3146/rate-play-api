...
// {
//     public class MoldRepository : IBaseRepository<線材櫃>
//     {
//         private readonly OfcoContext _context;
//         public MoldRepository(OfcoContext context)
//         {
//             _context = context;
//         }
...
//         /// </returns>
//         ///
//         public bool TryGetByWire(string wire_code, out 線材櫃 model)
//         {
//             model = _context.線材櫃.SingleOrDefault(x => wire_code.Equals(x.品號));
//             return (model != null);
//         }
//         #endregion
